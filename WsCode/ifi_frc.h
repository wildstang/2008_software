...
// software build.
// #define ENABLE_INT_1     // if enabled, used by encoder 1
// #define ENABLE_INT_2     // if enabled, used by encoder 2
// #define ENABLE_INT_3_6   // if enabled, used by encoders 3-6
// #define ENABLE_TIMER_0   // unused
// #define ENABLE_TIMER_1   // unused
// #define ENABLE_TIMER_2   // unused
// #define ENABLE_TIMER_3   // used the PWM software (leave disabled if using PWM code)
#define ENABLE_TIMER_4      // if enabled, used by the ADC software
...
// include stdio.h in every source file you use the _DEBUG() macro.
#ifdef _DEBUG
...
#define p1_sw_trig_prev  oi_swA_byte_prev.bitselect.bit0
#define p1_sw_top_prev   oi_swA_byte_prev.bitselect.bit1
#define p1_sw_aux1_prev  oi_swA_byte_prev.bitselect.bit2
#define p1_sw_aux2_prev  oi_swA_byte_prev.bitselect.bit3

#define p3_sw_trig_prev  oi_swA_byte_prev.bitselect.bit4
#define p3_sw_top_prev   oi_swA_byte_prev.bitselect.bit5
#define p3_sw_aux1_prev  oi_swA_byte_prev.bitselect.bit6
#define p3_sw_aux2_prev  oi_swA_byte_prev.bitselect.bit7

#define p2_sw_trig_prev  oi_swB_byte_prev.bitselect.bit0
#define p2_sw_top_prev   oi_swB_byte_prev.bitselect.bit1
#define p2_sw_aux1_prev  oi_swB_byte_prev.bitselect.bit2
#define p2_sw_aux2_prev  oi_swB_byte_prev.bitselect.bit3

#define p4_sw_trig_prev  oi_swB_byte_prev.bitselect.bit4
#define p4_sw_top_prev   oi_swB_byte_prev.bitselect.bit5
#define p4_sw_aux1_prev  oi_swB_byte_prev.bitselect.bit6
#define p4_sw_aux2_prev  oi_swB_byte_prev.bitselect.bit7
...
// this union is used for the previous state of the buttons
typedef union
{
  bitid bitselect;
...
extern RcButtonsType oi_swA_byte_prev; // located in ifi_frc.c
extern RcButtonsType oi_swB_byte_prev; // located in ifi_frc.c

// function prototypes for code in ifi_frc_xxxx.lib
