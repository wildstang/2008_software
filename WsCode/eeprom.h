...
#define ADDR_F_CRAB_MID_HI          3
#define ADDR_F_CRAB_MID_LO          4
#define ADDR_F_CRAB_LEFT_HI         5
#define ADDR_F_CRAB_LEFT_LO         6
#define ADDR_F_CRAB_RIGHT_HI        7
#define ADDR_F_CRAB_RIGHT_LO        8
#define ADDR_B_CRAB_MID_HI          9
#define ADDR_B_CRAB_MID_LO         10
#define ADDR_B_CRAB_LEFT_HI        11
#define ADDR_B_CRAB_LEFT_LO        12
#define ADDR_B_CRAB_RIGHT_HI       13
#define ADDR_B_CRAB_RIGHT_LO       14
/* if the number off bytes stored in eeprom changes, update NUM_EEPROM_BYTES
   in ws_includes.h */
