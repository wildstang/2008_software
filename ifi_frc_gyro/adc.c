...
*				kevinw@jpl.nasa.gov
*
*	COMMENTS:	This version will only work with 18F8722 based robot
*				controllers used in 2006-2008. You should use version
*				0.2 of this software, found in adc_8520.c, with a 2004
*				and 2005 18F8520 based robot controller.
*
